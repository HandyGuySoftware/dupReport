...
rcParts= [
    ...
    ('main','purgedbemail','false', True),  # DC
    ('main','nobackupwarn','0', True),  # DC
...
class OptionManager:
    ...
    def readRcOptions(self):
        ...
        #self.options['nobackupwarn'] = self.cmdLineArgs.nobackupwarn # DC
    ...
    def processCmdLineArgs(self):
        ...
        # DC No recent backups Warning Email
        #argParser.add_argument("-n","--nobackupwarn", help="Check last backup date and report warnings", action="store_true")
