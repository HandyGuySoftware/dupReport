...
| -v {3, 5, 7}                | --verbose {3, 5, 7}                         | Sets the verbosity of the information in the log file.       | 3=General program execution info. 5=Program flow and status information. 7=Full debugging output |
