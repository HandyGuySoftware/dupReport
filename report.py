...
def rptBottom(html, text, csv, start, nfld):
    ...
    html += '<br><br>Report generated by <a href=\'https://github.com/HandyGuySoftware/dupReport\'>dupReport</a> Version {}.{}.{} {} (Twitter: <a href=\'https://twitter.com/DupReport\'>@dupReport</a>)<br>'.format(globs.version[0], globs.version[1], globs.version[2], globs.status)
    html += '</body></html>'
    text += '\n\nReport generated by dupReport (https://github.com/HandyGuySoftware/dupReport) Version {}.{}.{} {} (Twitter: @dupReport)'.format(globs.version[0], globs.version[1], globs.version[2], globs.status)
    csv += '\n\"Report generated by dupReport (https://github.com/HandyGuySoftware/dupReport) Version {}.{}.{} {} (Twitter: @dupReport)\"'.format(globs.version[0], globs.version[1], globs.version[2], globs.status)
